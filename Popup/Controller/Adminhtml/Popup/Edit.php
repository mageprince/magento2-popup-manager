...
class Edit extends \Prince\Popup\Controller\Adminhtml\Popup
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('prince_popup_popup', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? $model->getTitle() : __('New Popup'));
        return $resultPage;
    }
}
